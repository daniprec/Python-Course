...
We will learn indexing in the [next page](modules/python-fundamentals/indexing.qmd). For now, just know that the index is the position of a character in a string. The first character has an index of 0, the second character has an index of 1, and so on.
:::
...
[Homework](homework_fundamentals.qmd#string-variables){.btn .btn-primary}
