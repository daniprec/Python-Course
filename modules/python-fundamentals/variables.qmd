...
Copy each example into your own notebook first and run it there before opening the solution. These cells are intentionally set not to run during render.
...
Copy the code into your own notebook first and run it there before opening the solution. This cell is intentionally set not to run during render.
...
In a new cell, enter your favorite number and store it in a variable called `fav_num`. Print out a message telling you what your favorite number plus 10 is.
