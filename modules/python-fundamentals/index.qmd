...
Start with the basics: printing output, variables, data types, and operations.
...
- **Additional Practice**: [Homework on Random Numbers](random_homework.qmd) for extra exercises
