...
[NumPy Introduction](introduction.qmd){.btn .btn-primary}

Learn arithmetic and mathematical operations on arrays.

[Array Arithmetics](arithmetics.qmd){.btn .btn-primary}

Master loading and saving numerical data.

[Loading & Saving Data](load.qmd){.btn .btn-primary}
...
[Random Numbers & Indexing](random_fancy_indexing.qmd){.btn .btn-primary}

Apply statistical operations to arrays.

[Statistics](statistics.qmd){.btn .btn-primary}
...
[Nilpotent Matrices](nilpotent_matrices.qmd){.btn .btn-secondary}
...
- **Exercises**: [Exercise: Assets](exercise_assets.qmd)

## Special Topics

- **Masking**: [NumPy Masking](masking.qmd) - Image manipulation with boolean masks
- **Random Operations**: [Random and Fancy Indexing](random_fancy_indexing.qmd)
