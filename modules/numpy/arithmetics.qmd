...
- Arithmetic operators act element by element on compatible arrays.
- Broadcasting compares shapes from right to left and allows dimensions that match or equal `1`.
- The `axis` argument controls the direction of an aggregation.
...
[Homework](homework_numpy.qmd#session-12-array-arithmetic-and-broadcasting){.btn .btn-primary}
