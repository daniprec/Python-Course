...
```{python}
ls = [1, 2, 3, 4, 5, "potato", False, print]
...
```{python}
foods = ["pizza", "coffee", "taco"]

def replace_first(ls):
  ls[0] = "apple"
  return ls

new_foods = replace_first(foods)
print(foods)  # ["pizza", "coffee", "taco"]
print(new_foods)  # ["apple", "coffee", "taco"]
```

```{python}
new_foods[1] = "orange juice"
...
def replace_first(ls):
  # Create a copy of my list to protect the original
  ls_copy = ls.copy()
  ls_copy[0] = "apple"
  return ls_copy
...
dict_copy = dict_ls.copy()
dict_copy["list"].append(4)
