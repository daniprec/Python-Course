...
: Sort the following list by the number of vowels that each item has (from smallest to largest).
...
: Modify the program above to add a second criterion. If two words have the same number of vowels, sort them by their length.
