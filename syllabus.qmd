...
### Module 2: Structures (3 lessons)
- Lists, tuples, sets
- Dictionaries and mapping patterns
- Comprehensions and sequence operations

### Module 3: NumPy (3 lessons)
- Arrays and vectorized operations
- Indexing, slicing, broadcasting
- Basic numerical workflows

### Module 4: IDEs & Tools (3 lessons)
